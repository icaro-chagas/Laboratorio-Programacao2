...
public class Facade {
	...
	public void adicionaProduto(String fornecedor, String nome, String descricao, double preco) {
		this.cc.adicionaProdutoComum(fornecedor, nome, descricao, preco);
	}
     ...
     * @param nome Nome do produto.
     * @param descricao Descrição do produto.
     * @param fator Fator de promoção do produto.
     * @param produtos Lista de produtos comuns que compõem o produto combo.
     */
	public void adicionaCombo(String fornecedor, String nome, String descricao, double fator, String produtos) {
		this.cc.adicionaProdutoCombo(fornecedor, nome, descricao, fator, produtos);
	}
	...
	public void editaProduto(String fornecedor, String nome, String descricao, double novoPreco) {
		this.cc.editaProdutoComum(fornecedor, nome, descricao, novoPreco);
	}
	
	/**
     * Altera o fator de promoção de um produto combo.
     * 
     * @param nome Nome do produto.
     * @param descricao Descrição do produto.
     * @param fornecedor Nome do Fornecedor.
     * @param novoFator Novo fator de promoção do produto.
     */
	public void editaCombo(String nome, String descricao, String fornecedor, double novoFator) {
		this.cc.editaProdutoCombo(nome, descricao, fornecedor, novoFator);
	}
